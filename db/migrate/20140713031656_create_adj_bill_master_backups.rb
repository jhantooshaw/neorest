class CreateAdjBillMasterBackups < ActiveRecord::Migration
  def change
    ...
    add_index :adj_bill_master_backups, :bill_date
    add_index :adj_bill_master_backups, :pay_type
    add_index :adj_bill_master_backups, :customer_id
    add_index :adj_bill_master_backups, :customer_name
    add_index :adj_bill_master_backups, :canceled
  end
end